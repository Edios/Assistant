...
class BikeStatistics:
    ...
    def get_athlete_statistics(self, athlete_id):
        send_get_request(f'https://www.strava.com/api/v3//athletes/{athlete_id}/stats', bearer_token=self.strava_token)

    def get_statistic_between_range(self, before_date, after_date) -> Stats:
        ...
        stats = Stats(ride_count, summary_distance, elapsed_time)
        return stats
